...
void OLED_Init(void)
{
	...
	//uint8_t buff[8][128] = {0x11,0x12,0x11,0x12,0x11,0x12,0x11,0x12,0x11,0x12,0x11,0x12,0x11,0x12};
...
void OLED_SendBuff(uint8_t buff[8][128]){
    for (uint8_t page = 0; page < 8; page++) {
        ...
        OLED_WriteCommand(0x00);        // Set Column Low Address
        OLED_WriteCommand(0x10);        // Set Column High Address

        for (uint8_t col = 0; col < 128; col++) {
            OLED_WriteData(buff[page][col]);
        }
    }
}
